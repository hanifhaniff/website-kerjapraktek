                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <form action="tambahbarangkeluar().php" method="POST">
                            <div class="mb-3">
                              <label class="col-form-label pt-0" for="nama">Nama Barang</label>
                              <select class="form-select digits" id="nama" name="nama">
                                <?php 
                                    $result = mysqli_query($mysqli, "SELECT nama FROM databarang");
                                    $i = 0;
                                    while($res = mysqli_fetch_array($result)) {	
                                        echo "<option>".$res['nama']."</option>";	
                                    }
                                ?>
                             </select>
                            </div>
                            ...
                            <label class="col-sm-3 col-form-label">Tanggal Keluar</label>
                              <input class="form-control digits" name="tanggalkeluar" type="date" value="2018-01-19T18:45:00">
                            </div>
                            <div class="mb-3">
                              <label class="col-form-label pt-0" for="jumlahkeluar">Jumlah</label>
                              <input class="form-control" name="jumlahkeluar" type="text" placeholder="Masukkan Jumlah (Yard)">
                            </div>
