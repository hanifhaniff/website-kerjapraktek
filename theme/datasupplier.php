            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <button class="btn btn-primary"  type="button" onclick="document.location.href='tambahdatasupplier.php';">Tambah Data Supplier</button></br></br>
                      <thead>
                        <tr>
                          <th scope="col" style="width:20px">No</th>
                          <th scope="col" style="width:250px">>Kode Supplier</th>
                          <th scope="col">Nama Supplier</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php 
                            $result = mysqli_query($mysqli, "SELECT * FROM datasupplier");
                            $i = 0;
                            while($res = mysqli_fetch_array($result)) {
                                $i++;		
                                echo "<tr>";
                                echo "<th>".$i."</th>";
                                echo "<td>".$res['kdsupp']."</td>";
                                echo "<td>".$res['nama']."</td>";	
                                echo "</tr>";		
                            }
                        ?>
