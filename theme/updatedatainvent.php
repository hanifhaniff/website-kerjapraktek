...
$id = $_GET['id'];
$result = mysqli_query($mysqli, "SELECT * FROM databarang WHERE kdbrg='$id'");
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <form action="updatedatainvent().php" method="POST">
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="kdbrg">Kode Barang</label>
                            <input class="form-control" name="kdbrg" type="text" value="<?php echo $kdbrg;?>" readonly>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="nama">Nama Barang</label>
                            <input class="form-control" name="nama" type="text" value="<?php echo $nama;?>" readonly>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="pass">Lokasi</label>
                            <input class="form-control" name="lokasi" type="text" value="<?php echo $lokasi;?>">
                          </div>
                          <button class="btn btn-primary" name="submit">Submit</button>
                          <button class="btn btn-secondary" name="clear">Cancel</button>
                        </form>
                      </div>
                    </div>
                  </div>
