          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    <h2>Data Barang Masuk</h2></br>
                    <div class="dt-ext table-responsive">
                      <table class="display" id="basic-key-table">
                      <button class="btn btn-primary"  type="button" onclick="document.location.href='tambahbarangmasuk.php';">Tambah Data Barang Masuk</button></br></br>
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <?php 
                            $result = mysqli_query($mysqli, "SELECT * FROM databarangmasuk");
                            $i = 0;
