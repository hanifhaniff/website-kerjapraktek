                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <form action="tambahdatasupplier().php" method="POST">
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="kdsupp">Kode Supplier</label>
                            <input class="form-control" name="kdsupp" type="text" placeholder="Masukkan Kode Supplier">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="nama">Nama Supplier</label>
