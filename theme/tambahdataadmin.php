                      ...
                      <div class="card-body">
                        <form action="tambahdataadmin().php" method="POST">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" name="email" type="email" aria-describedby="emailHelp" placeholder="Masukkan Email">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="nohp">Nomor HP</label>
                            <input class="form-control" name="no" type="text" placeholder="Masukkan Nomor HP">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="pass">Password</label>
                            <input class="form-control" name="pass" type="password" placeholder="Masukkan Password">
                          </div>
                          <div class="mb-3">
                              <label class="col-form-label pt-0" for="level">Level</label>
                              <select class="form-select digits" id="level" name="level">
