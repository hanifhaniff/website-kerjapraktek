                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="dt-ext table-responsive">
                      ...
                      <tbody>
                        <?php 
                            $result = mysqli_query($mysqli, "SELECT * FROM databarang");
                            $i = 0;
                            while($res = mysqli_fetch_array($result)) {
                                ...
                                echo "<td>".$res['nama']."</td>";	
                                echo "<td>".$res['lokasi']."</td>";	
                                echo "<td>".$res['jumlah']." </td>";	
                                echo "<td><a href='updatedatainvent.php?id=".$res['kdbrg']."'>Update</a></td>";
                                echo "</tr>";		
                            }
                        ?>
                      </tbody>
